...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('vendors/nice-select/nice-select.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('vendors/owl-carousel/owl.theme.default.min.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('vendors/owl-carousel/owl.carousel.min.css')}}">
